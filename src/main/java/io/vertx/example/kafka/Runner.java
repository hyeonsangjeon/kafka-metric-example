...
public class Runner {
    ...
    private static final String UNIT_EXAMPLES_DIR = "kafka-metric-examples";
    private static final String UNIT_EXAMPLES_JAVA_DIR = UNIT_EXAMPLES_DIR + "/src/main/java/io/vertx/example/kafka/dashboard/";
